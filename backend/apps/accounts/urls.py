...
urlpatterns = [
    ...
    path(
        "mfa/verify-setup/", views.MFAVerifySetupView.as_view(), name="mfa-verify-setup"
    ),
    path(
        "mfa/verify-login/", views.MFALoginVerifyView.as_view(), name="mfa-verify-login"
    ),
    path("mfa/disable/", views.MFADisableView.as_view(), name="mfa-disable"),
    path(
        "mfa/backup-codes/generate/",
        views.MFAGenerateBackupCodesView.as_view(),
        name="mfa-backup-codes-generate",
    ),
    path(
        "mfa/backup-codes/verify/",
        views.MFAVerifyBackupCodeView.as_view(),
        name="mfa-backup-codes-verify",
    ),
