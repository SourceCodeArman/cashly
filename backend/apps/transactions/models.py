...
class CategoryManager(models.Manager):
    ...
    def for_user(self, user):
        ...
        return self.filter(
            models.Q(is_system_category=True) | models.Q(user=user)
        )
...
class Category(models.Model):
    ...
    rules = models.JSONField(default=dict, blank=True, help_text="Auto-categorization rules")
...
class Transaction(models.Model):
    ...
    is_transfer = models.BooleanField(
        default=False,
        help_text="Internal transfer between accounts"
    )
