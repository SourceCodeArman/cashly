                ...
                <div className="flex space-x-1 p-1">
                    {[
                        ...
                        <button
                            ...
                            className={`flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-none border-b-2 transition-colors ${activeTab === id
                                    ...
                                    transactions.map((transaction) => (
                                        <Card key={transaction.transactionId} className="border-0 shadow-sm hover:shadow-md transition-shadow">
                                            <CardContent className="p-4">
                                                <div className="flex items-center justify-between">
                                                    <div className="flex items-center gap-3">
                                                        <div className={`h-10 w-10 rounded-full flex items-center justify-center ${parseFloat(transaction.amount) > 0
                                                    ...
                                                    <div className="text-right">
                                                        <div className={`font-bold text-lg ${parseFloat(transaction.amount) > 0 ? 'text-green-600' : 'text-foreground'
                                                            }`}>
